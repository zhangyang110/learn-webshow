...
------------- | ------------- | -------------
[**gamesGet**](GamesApi.md#gamesGet) | **GET** /games | Returns all game in the database.
[**gamesIdGet**](GamesApi.md#gamesIdGet) | **GET** /games/{id} | 
[**gamesIdPut**](GamesApi.md#gamesIdPut) | **PUT** /games/{id} | put game


<a name="gamesGet"></a>
# **gamesGet**
> CommonResponse gamesGet(opts)
...
let apiInstance = new Tvapi.GamesApi();
...
apiInstance.gamesIdGet(id, ).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
<a name="gamesIdPut"></a>
# **gamesIdPut**
> CommonResponse gamesIdPut(id, body)
...
let body = new Tvapi.Game(); // Game | 

apiInstance.gamesIdPut(id, body).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});

...
------------- | ------------- | -------------
[**subjectsGet**](SubjectsApi.md#subjectsGet) | **GET** /subjects | Returns all subject in the database.
[**subjectsIdGet**](SubjectsApi.md#subjectsIdGet) | **GET** /subjects/{id} | 
[**subjectsIdPut**](SubjectsApi.md#subjectsIdPut) | **PUT** /subjects/{id} | put subject
[**subjectsPost**](SubjectsApi.md#subjectsPost) | **POST** /subjects | create a subject


<a name="subjectsGet"></a>
# **subjectsGet**
> CommonResponse subjectsGet(opts)
...
let apiInstance = new Tvapi.SubjectsApi();
...
apiInstance.subjectsGet(opts).then((data) => {
...
# **subjectsIdGet**
> CommonResponse subjectsIdGet(id, )
...
apiInstance.subjectsIdGet(id, ).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
# **subjectsIdPut**
> CommonResponse subjectsIdPut(id, body)
...
let body = new Tvapi.Subject(); // Subject | 

apiInstance.subjectsIdPut(id, body).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
# **subjectsPost**
> CommonResponse subjectsPost(body)
...
let body = new Tvapi.Subject(); // Subject | The subject subject to create

apiInstance.subjectsPost(body).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**Subject**](Subject.md)| The subject subject to create | 

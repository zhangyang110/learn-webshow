...
import EventExtraParameterDetail from './EventExtraParameterDetail';
...
export default class InlineResponse2005 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [EventExtraParameterDetail]);
            }
        }
        return obj;
    }
    ...
    */
    message = undefined;
    /**
    * @member {Array.<module:model/EventExtraParameterDetail>} data
    */
    data = undefined;

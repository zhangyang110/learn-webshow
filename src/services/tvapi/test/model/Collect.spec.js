...
(function(root, factory) {
  ...
  describe('Collect', function() {
    it('should create an instance of Collect', function() {
      // uncomment below and update the code to test Collect
      //var instane = new Tvapi.Collect();
      //expect(instance).to.be.a(Tvapi.Collect);
    });

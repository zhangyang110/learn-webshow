...
(function(root, factory) {
  ...
  describe('FreeSeries', function() {
    it('should create an instance of FreeSeries', function() {
      // uncomment below and update the code to test FreeSeries
      //var instane = new Tvapi.FreeSeries();
      //expect(instance).to.be.a(Tvapi.FreeSeries);
    });

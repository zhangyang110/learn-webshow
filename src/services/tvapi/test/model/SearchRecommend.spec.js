...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tvapi.SearchRecommend();
  });
  ...
  describe('SearchRecommend', function() {
    it('should create an instance of SearchRecommend', function() {
      // uncomment below and update the code to test SearchRecommend
      //var instane = new Tvapi.SearchRecommend();
      //expect(instance).to.be.a(Tvapi.SearchRecommend);
    });
